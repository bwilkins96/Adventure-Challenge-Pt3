...
class World {
  ...
  static loadWorld(worldData) {
    ...
    for (let i = 0 ; i < enemyList.length ; i++) {
      ...
      if (enemyData.isBailey) {newEnemy = new Bailey(enemyData.name, enemyData.description, enemyRoom)}
      else {newEnemy = new Enemy(enemyData.name, enemyData.description, enemyRoom)}
